...
import type { MObjectField, ObjectKind } from "../../../types";
import type { KindFormChangeEvent } from "./use-kind-form";

interface KindSettingsProps {
  /** The kind being edited — the form's working copy, so possibly partial. */
  kindData: Partial<ObjectKind>;
  /** Fields of this kind keyed by field_id; null while loading. */
  fieldData: Record<string, MObjectField> | null;
  /** All kinds (for the parent-kind selector). */
  kinds: ObjectKind[] | null | undefined;
  onFieldChange: (
    fieldName: string,
