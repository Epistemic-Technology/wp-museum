...
import type { ObjectKind, MObjectField } from "../../src/types";
...
test.describe("Auto-generate catalogue IDs (#30)", () => {
  ...
  test.beforeAll(async ({ browser }) => {
    ...
    const allKinds: ObjectKind[] = await kindsResp.json();
    ...
    const fields = Object.values(await fieldsResp.json()) as MObjectField[];
